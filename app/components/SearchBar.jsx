...
const SearchBar = () => {
	...
	return (
		<>
			<div className='flex flex-row justify-evenly items-center text-[10px] md:text-[20px]  leading-[80px] md:h-[80px] md:w-full bg-transparent border-b-[3px] border-b-[#AAAAAA4D]'>
